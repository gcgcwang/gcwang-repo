...
import com.nang.core.util.StringUtil;
...
public class FreemarkerUtil {
	...
	static{
	 ...
	 public static void main(String[] args) {
	    	...
	    	setting.setPackageName("com.nang.module.system.vo");
	    	...
	    	buildAndWriteTemple("tmpVO.ftl",  CLASS_PATH+"/com/nang/temple/ftl"
