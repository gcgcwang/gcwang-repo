...
<div class="wrapper">
    ...
    <section class="sidebar"  :class="{'show':isShowMenu,' hide':!isShowMenu}">
      <ul class="sidebar-menu" data-widget="tree">
         ...
         <li v-for="rootMenu in rootMenus" class="treeview">
          <a href="#" >
            <i class="fa fa-dashboard"></i> <span>{{rootMenu.menuName}}</span>
          ...
          <ul class="treeview-menu">
            <li v-for="conMenu in conMenus" v-if="conMenu.parentId==rootMenu.menuId"><a href="#" v-on:click="tabToCon(conMenu)"><i class="fa fa-circle-o"></i> {{conMenu.menuName}}</a></li>
			</ul>
        </li>
      </ul>
    </section>
  ...
  <div  class="content-wrapper"   :class="{'':isShowMenu,'onset':!isShowMenu}"  >
    ...
    <iframe width="100%" frameborder="0" v-bind:height="frmHeight" scrolling="no" v-bind:src="basePath+(curr_tabMenu.link?curr_tabMenu.link:index_url)" style="background:#FFF"></iframe>
...
<script type="text/javascript">
 ...
 new Vue({
   	...
   	data:{
   		...
   		conMenus:${conMenus},
   		tabMenus:[],
   		frmHeight:document.documentElement.clientHeight-100
   	},
	methods:{
